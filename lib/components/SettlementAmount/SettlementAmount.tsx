...
const SettlementAmount = ({
  ...
  return (
    <Modal
      ...
      className="mb-2"
      aria-labelledby="unsettled-amount-modal"
      aria-describedby="unsettled-amount-modal"
      onClose={onClose}
    >
      <ModalContent>
        <div className="px-6 py-8 md:px-8">
          <h1 className="text-2xl font-bold text-center mb-6 bg-gradient-to-r from-[#53BEC2] to-[#00EF64] bg-clip-text text-transparent">
            Manual Payout
          </h1>
              ...
              <div className="w-full">
                <label className="block mb-2 text-sm font-semibold text-gray-800">
                  ...
                  {!isMerchantListLoading && beneficiaryList.length > 0 && (
                    <span className="text-[#00EF64] ml-2 text-xs font-normal">
