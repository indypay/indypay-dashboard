  ...
  return (
    ...
    <div className="flex flex-col w-screen max-h-screen">
      ...
      <div className="flex flex-col">
        {/* Header skeleton */}
        <div
          className="absolute h-[85px] top-0 bg-gray-300 animate-pulse"
          style={{ left: '6rem', width: 'calc(100% - 6rem)' }}
        >
          <div className="relative">
            <div className="absolute bg-gray-200 animate-pulse w-40 h-12 left-2 top-5 rounded-md"></div>
            <div className="absolute bg-gray-200 animate-pulse w-36 h-10 top-6 right-5 rounded-md"></div>
            <div className="absolute bg-gray-200 animate-pulse w-10 h-10 top-6 right-44 rounded-md"></div>
          </div>
        </div>
